...
/**
 * The code on this class was based on the source code uploaded
 * by Amilcar Pontes on Moodle under Week 5.
 * It was since then expanded and adapted to match the deliverables from the CA1 brief.
 * 
 * Class responsible for handling the requests and responses from the DB.
 * Only class with direvt access to it.
 */
public class DataSource {
	...
	/**
	 * Method responsible for adding statements into the DB
	 * @param query
	 */
	public boolean save(String query){
			try {
				stmt.execute(query); //saves the data as it's been given
				return true;
			}
